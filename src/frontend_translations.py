...
UI_TEXT = {
    "en": {
        ...
        "png_required": "The photo must be a readable image. It will be converted to PNG automatically.",
    ...
    "es": {
        ...
        "png_required": "La foto debe ser una imagen válida. Se convertirá automáticamente a PNG.",
